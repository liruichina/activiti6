...
//    @Test
    public List<Task> findPersonalTaskList(String processDefinitionKey,String assignee){
        ...
        for (Task task : list) {
            ...
            System.out.println("流程实例id：" + getProcessInstanceName(task.getProcessInstanceId()));
//            System.out.println("任务名称：" + task.getProcessInstanceId());
//            if(task.getId().equals("315193")) {
//            	;
//            }
...
//    Query processInstanceQuery = runtimeService.createProcessInstanceQuery();
